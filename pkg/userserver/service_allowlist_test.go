...
func TestIsAllowed_NoMatchingEntry(t *testing.T) {
	...
	tsc := utils.TargetServiceConfig{Namespace: "default", Service: "other-service", Port: "8080", Proto: "https"}
	if a.IsAllowed(tsc) {
...
func TestIsAllowed_MultipleEntries_SecondMatches(t *testing.T) {
	...
	tsc := utils.TargetServiceConfig{Namespace: "default", Service: "my-api", Port: "8080", Proto: "https"}
	if !a.IsAllowed(tsc) {
...
func TestServiceAllowlist_ConcurrentReadWrite(t *testing.T) {
	a := &ServiceAllowlist{}
	tsc := utils.TargetServiceConfig{Namespace: "ns", Service: "svc", Port: "80", Proto: "https"}
...
// ---------------------------------------------------------------------------
// ServiceAllowlist.update — nil clears the list (deny-all)
// ---------------------------------------------------------------------------
